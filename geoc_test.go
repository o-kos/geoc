...
func TestCoordFormatPositive(t *testing.T) {
	testCases := []struct {
		...
		{`70.3177778`, `70.19.4N`, `70.19.4N`},
		{`18.1180556`, `018.07.5E`, `018.07.5E`},
...
func TestParseCoordPositive(t *testing.T) {
	testCases := []struct {
		...
		{`70.19.4N`, 70.317777, LocLat},
		{`018.07.5E`, 18.118055, LocLon},
...
func TestParsePointPositive(t *testing.T) {
	testCases := []struct {
		...
		{`48-33-27N 120-5749E`, 48.5575, 120.963611},
		{`70.19.4N-120.57.49E`, 70.317777, 120.963611},
		{`70.19.4N-018.07.5E`, 70.317777, 18.118055},
		{`48N120E`, 48, 120},
		{` 48N;120E `, 48, 120},
	}
